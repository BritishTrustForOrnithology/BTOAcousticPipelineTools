...
#' BTOAcousticPipelineTools. You will only need to run this once on each 
...
#get CRAN packages
install_packages(packages = c("shiny", "shinyFiles", "shinyalert", "shinyjs", "devtools", "tidyr", "DT", "xml2", "tuneR") )
